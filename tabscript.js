...
function display() {
    var autoclickertext = (autoclickerlevel === 0) ? "unlock the autoclicker." : "increase the level of the autoclicker"
    ...
    // (autoclickerlevel === 0) ? "unlock the autoclicker." : "increase the level of the autoclicker"
    ...
    function achievementsMessage() {
        ...
        achievementsArray.forEach((v) => {
            var completedMessage = (v.completed) ? "completed" : "notcompleted"
            //if (v.completed) {
            //completedMessage="completed"
 
            //}
            var miniMessage = "<tr class='" + completedMessage + "'><td class='achievement'>"+ v.name + " </td><td class='howtoget'> &nbsp &nbsp &nbsp how to get:   " + v.description + "</td></tr>"
